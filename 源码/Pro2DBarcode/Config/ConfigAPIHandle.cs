...
namespace Pro2DBarcode.Config
{
    ...
    public class ConfigAPIHandle
    {
        ...
        /// <returns></returns>
        public static bool Save<T>(T t,string filePath) where T : Pro2DBarcode.Config.Config
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        public static T Load<T>(string filePath) where T:Pro2DBarcode.Config.Config,new ()
        {
            try
            {
