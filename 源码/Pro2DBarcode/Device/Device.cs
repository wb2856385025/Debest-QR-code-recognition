...
namespace Pro2DBarcode.Device
{
    ...
    public abstract class Device : IDevice
    {
        ...
        public void Init()
        {
            Pro2DBarcode.Manager.UIManager.Instance.AddRunLog("", this.ToString(), "初始化");
            DoIni();
        }
        ...
        public void Start()
        {
            Pro2DBarcode.Manager.UIManager.Instance.AddRunLog("", this.ToString(), "启动");
            DoStart();
        }
        ...
        public void Stop()
        {
            Pro2DBarcode.Manager.UIManager.Instance.AddRunLog("", this.ToString(), "停止");
            DoStop();
        }
        ...
        public void Release()
        {
            Pro2DBarcode.Manager.UIManager.Instance.AddRunLog("", this.ToString(), "释放");
            DoRelease();
        }
