...
namespace csDmc2210
{
    public class Dmc2210
    {
        ...
        *********************************************************************************/
        ...
        public static extern UInt16 d2210_axis_status(UInt16 axis);
        ...
        public static extern Int32 d2210_get_equiv(UInt16 axis, ref double equiv);
        [DllImport("Dmc2210.dll", EntryPoint = "d2210_set_equiv", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 d2210_set_equiv(UInt16 axis, double new_equiv);
        [DllImport("Dmc2210.dll", EntryPoint = "d2210_arc_move_unitmm", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern void d2210_arc_move_unitmm(ref UInt16 axis, ref double target_pos, ref double cen_pos, UInt16 arc_dir);
        ...
        public static extern void d2210_rel_arc_move_unitmm(ref UInt16 axis, ref double rel_pos, ref double rel_cen, UInt16 arc_dir);
