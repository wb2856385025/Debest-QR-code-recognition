...
namespace ProDriver.Driver
{
    ...
    {
        private IntPtr _ghandle = (IntPtr)0;

        #region 实现抽象函数
        public override bool DoConnectCtrller(string ip,int port)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        public override bool DoSetAxisALMIn(int naxis, int inputno)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="inputno">输入端口位号</param>
        /// <returns></returns>
        public override bool DoSetAxisHRevIn(int naxis, int inputno)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="inputno">输入端口位号</param>
        /// <returns></returns>
        public override bool DoSetAxisDatumIn(int naxis, int inputno)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="inputno">输入端口位号</param>
        /// <returns></returns>
        public override bool DoSetAxisHFwdIn(int naxis, int inputno)
        {
            bool rt = false;
            try
            {
        ...
        {
            bool rt = false;
            if (this.SetAxisSramp(naxis, 100.0f))  //设置运控曲线0--Trapezium,1.0--Sigmoid
            {
                if (this.SetAxisInitspeed(naxis, lspeed))
                {
                    if (this.SetAxisSteadySpeed(naxis, maxspeed))
        ...
        /// <returns></returns>
        public override bool DoSingleRelMove(int naxis, float pos)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        public override bool DoSingleAbsMove(int naxis, float pos)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        public override bool DoCancelAxisList(int[] axispos)
        {
            bool rt = false;
            try
            {
                if (_ghandle.ToInt64() != 0)
                {
                    if (cszmcaux.zmcaux.ZAux_Direct_CancelAxisList(_ghandle,axispos.Count(), axispos, 3) == 0)
                    {
                        rt = true;
                    }
                }
