...
namespace ProDriver.Driver
{
    ...
    public abstract class BoardDriver : IBoardDriver
    {
        ...
        #region 抽象成员(钩子函数)
        public abstract bool DoConnectCtrller(string ip,int port);     
        ...
        public abstract bool DoSetAxisALMIn(int naxis, int inputno);
        public abstract bool DoGetAxisALMIn(int naxis, ref int inputno); 
        public abstract bool DoSetAxisHRevIn(int naxis, int inputno);
        ...
        public abstract bool DoSetAxisDatumIn(int naxis, int inputno);
        public abstract bool DoGetAxisDatumIn(int naxis, ref int inputno);    
        public abstract bool DoSetAxisHFwdIn(int naxis, int inputno);
        ...
        public abstract bool DoSingleRelMove(int naxis, float pos);
        public abstract bool DoSingleAbsMove(int naxis, float pos);
        public abstract bool DoCancelAxisList(int[] axispos);
